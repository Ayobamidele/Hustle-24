    ...
    juYr: function(t, e, n) {
        ...
        !function(e, n) {
            ...
            function u(t, e, n) {
                ...
                }) : $t.test(e) ? yt.filter(e, t, n) : (e = yt.filter(e, t),
            ...
            function y(t, e, n) {
                ...
                if (void 0 === n && 1 === t.nodeType)
                    if (i = "data-" + e.replace(Ft, "-$&").toLowerCase(),
            ...
            function b(t, e, n, i) {
                ...
                , l = a(), u = n && n[3] || (yt.cssNumber[e] ? "" : "px"), c = (yt.cssNumber[e] || "px" !== u && +l) && Mt.exec(yt.css(t, e));
                if (c && c[3] !== u) {
                    u = u || c[3],
                    n = n || [],
                    c = +l || 1;
            ...
            function w(t, e) {
                for (var n, i, o = [], r = 0, s = t.length; r < s; r++)
                    ...
                    e ? ("none" === n && (o[r] = Wt.get(i, "display") || null,
                    o[r] || (i.style.display = "")),
                    "" === i.style.display && Ut(i) && (o[r] = x(i))) : "none" !== n && (o[r] = "none",
                    Wt.set(i, "display", n)));
                for (r = 0; r < s; r++)
            ...
            function L(t, e, n, i) {
                ...
                if (g || f > 1 && "string" == typeof d && !vt.checkClone && re.test(d))
                    return t.each(function(o) {
                        var r = t.eq(o);
                        g && (e[0] = d.call(this, o, r.html())),
                        L(r, e, n, i)
                    });
                if (f && (o = E(e, t[0].ownerDocument, !1, t, i),
                r = o.firstChild,
                1 === o.childNodes.length && (o = r),
                r || i)) {
                    for (a = yt.map(T(o, "script"), N),
                    l = a.length; h < f; h++)
                        u = o,
                        h !== p && (u = yt.clone(u, !0, !0),
                    ...
                    if (l)
                        ...
                        h = 0; h < l; h++)
                            u = a[h],
                            Gt.test(u.type || "") && !Wt.access(u, "globalEval") && yt.contains(c, u) && (u.src ? yt._evalUrl && yt._evalUrl(u.src) : s(u.textContent.replace(ae, ""), c))
                }
                return t
            }
            function _(t, e, n) {
            ...
            function q(t) {
                var e = yt.cssProps[t];
                return e || (e = yt.cssProps[t] = W(t) || t),
                e
            }
            function H(t, e, n) {
                var i = Mt.exec(e);
            ...
            function F(t, e, n, i, o) {
                ...
                for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)
                    ...
                    i ? ("content" === n && (s -= yt.css(t, "padding" + zt[r], !0, o)),
                    "margin" !== n && (s -= yt.css(t, "border" + zt[r] + "Width", !0, o))) : (s += yt.css(t, "padding" + zt[r], !0, o),
            ...
            function z() {
                ye && (!1 === st.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(z) : n.setTimeout(z, yt.fx.interval),
                yt.fx.tick())
            }
            function U() {
            ...
            function V(t, e, n) {
                var i, o, r, s, a, l, u, c, h = "width"in e || "height"in e, f = this, p = {}, d = t.style, g = t.nodeType && Ut(t), m = Wt.get(t, "fxshow");
                ...
                if ((l = !yt.isEmptyObject(e)) || !yt.isEmptyObject(p)) {
                    ...
                    l = !1;
                    for (i in p)
                        l || (m ? "hidden"in m && (g = m.hidden) : m = Wt.access(t, "fxshow", {
                            display: u
                        }),
                        r && (m.hidden = !g),
                        g && w([t], !0),
            ...
            function G(t, e, n) {
                var i, o, r = 0, s = G.prefilters.length, a = yt.Deferred().always(function() {
                    ...
                    if (o)
                        return !1;
                    for (var e = ve || U(), n = Math.max(0, u.startTime + u.duration - e), i = n / u.duration || 0, r = 1 - i, s = 0, l = u.tweens.length; s < l; s++)
                        u.tweens[s].run(r);
            ...
            var Ct = function(t) {
                function e(t, e, n, i) {
                    ...
                    "string" != typeof t || !t || 1 !== d && 9 !== d && 11 !== d)
                        return n;
                    if (!i && ((e ? e.ownerDocument || e : q) !== I && N(e),
                    e = e || I,
                    O)) {
                        if (11 !== d && (l = gt.exec(t)))
                            if (o = l[1]) {
                        ...
                        if (x.qsa && !z[t + " "] && (!L || !L.test(t))) {
                            if (1 !== d)
                                ...
                                for ((a = e.getAttribute("id")) ? a = a.replace(bt, xt) : e.setAttribute("id", a = W),
                                c = E(t),
                                r = c.length; r--; )
                                    c[r] = "#" + a + " " + h(c[r]);
                                f = c.join(","),
                                p = mt.test(t) && u(e.parentNode) || e
                            }
                            if (f)
                                try {
                ...
                function m(t, e, n, o, r, s) {
                    ...
                    r && !r[W] && (r = m(r, s)),
                    i(function(i, s, a, l) {
                        var u, c, h, f = [], p = [], m = s.length, v = i || d(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : g(v, f, t, a, l), b = n ? r || (i ? t : m || o) ? [] : s : y;
                        if (n && n(y, b, a, l),
                        o)
                            for (u = g(b, p),
                            o(u, [], a, l),
                ...
                function y(t, n) {
                    var o = n.length > 0
                      ...
                      , s = function(i, s, a, l, u) {
                        var c, h, f, p = 0, d = "0", m = i && [], v = [], y = D, b = i || r && w.find.TAG("*", u), x = H += null == y ? 1 : Math.random() || .1, T = b.length;
                        for (u && (D = s === I || s || u); d !== T && null != (c = b[d]); d++) {
                            if (r && c) {
                                for (h = 0,
                                s || c.ownerDocument === I || (N(c),
                                a = !O); f = t[h++]; )
                                    if (f(c, s || I, a)) {
                                        l.push(c);
                                        break
                ...
                var b, x, w, T, C, E, S, k, D, $, A, N, I, j, O, L, _, R, P, W = "sizzle" + 1 * new Date, q = t.document, H = 0, F = 0, B = n(), M = n(), z = n(), U = function(t, e) {
                    return t === e && (A = !0),
                    0
                    ...
                    for (var n = 0, i = t.length; n < i; n++)
                        if (t[n] === e)
                            return n;
                    return -1
                }, K = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", tt = "[\\x20\\t\\r\\n\\f]", et = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", nt = "\\[" + tt + "*(" + et + ")(?:" + tt + "*([*^$|!~]?=)" + tt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + et + "))|)" + tt + "*\\]", it = ":(" + et + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + nt + ")*)|.*)\\)|)", ot = new RegExp(tt + "+","g"), rt = new RegExp("^" + tt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + tt + "+$","g"), st = new RegExp("^" + tt + "*," + tt + "*"), at = new RegExp("^" + tt + "*([>+~]|" + tt + ")" + tt + "*"), lt = new RegExp("=" + tt + "*([^\\]'\"]*?)" + tt + "*\\]","g"), ut = new RegExp(it), ct = new RegExp("^" + et + "$"), ht = {
                    ID: new RegExp("^#(" + et + ")"),
                    CLASS: new RegExp("^\\.(" + et + ")"),
                    TAG: new RegExp("^(" + et + "|[*])"),
                    ATTR: new RegExp("^" + nt),
                ...
                }, ft = /^(?:input|select|textarea|button)$/i, pt = /^h\d$/i, dt = /^[^{]+\{\s*\[native \w/, gt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, mt = /[+~]/, vt = new RegExp("\\\\([\\da-f]{1,6}" + tt + "?|(" + tt + ")|.)","ig"), yt = function(t, e, n) {
                    var i = "0x" + e - 65536;
                ...
                N = e.setDocument = function(t) {
                    ...
                    _ = [],
                    L = [],
                    (x.qsa = dt.test(I.querySelectorAll)) && (o(function(t) {
                    ...
                    P = e || dt.test(j.contains) ? function(t, e) {
                    ...
                    U = e ? function(t, e) {
                        ...
                        1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === I || t.ownerDocument === q && P(q, t) ? -1 : e === I || e.ownerDocument === q && P(q, e) ? 1 : $ ? J($, t) - J($, e) : 0 : 4 & n ? -1 : 1)
                    }
                    : function(t, e) {
                        if (t === e)
                            return A = !0,
                        ...
                        if (!o || !r)
                            return t === I ? -1 : e === I ? 1 : o ? -1 : r ? 1 : $ ? J($, t) - J($, e) : 0;
                        if (o === r)
                            return s(t, e);
                ...
                e.contains = function(t, e) {
                    return (t.ownerDocument || t) !== I && N(t),
                    P(t, e)
                }
                ,
                e.attr = function(t, e) {
                ...
                w = e.selectors = {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function(t) {
                            var e, n = !t[6] && t[2];
                            return ht.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && ut.test(n) && (e = E(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                            t[2] = n.slice(0, e)),
                            t.slice(0, 3))
                        }
                    },
                    filter: {
                        ...
                        CHILD: function(t, e, n, i, o) {
                            ...
                            : function(e, n, l) {
                                var u, c, h, f, p, d, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a, b = !1;
                                if (m) {
                                    if (r) {
                                        for (; g; ) {
                                            for (f = e; f = f[g]; )
                                    ...
                                    b = p),
                                    !1 === b)
                                        for (; (f = ++p && f && f[g] || (b = p = 0) || d.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (h = f[W] || (f[W] = {}),
                                        c = h[f.uniqueID] || (h[f.uniqueID] = {}),
                                        c[t] = [H, b]),
                                        f !== e)); )
                                            ;
                        ...
                        PSEUDO: function(t, n) {
                            ...
                            return r[W] ? r(n) : r.length > 1 ? (o = [t, t, "", n],
                ...
                k = e.select = function(t, e, n, i) {
                    ...
                    1 === f.length) {
                        ...
                        r.length > 2 && "ID" === (s = r[0]).type && 9 === e.nodeType && O && w.relative[r[1].type]) {
                    ...
                    return (c || S(t, f))(i, e, !O, n, !e || mt.test(t) && u(e.parentNode) || e),
                    n
                }
                ,
            ...
            yt.each({
                ...
                yt.fn[t] = function(n, i) {
                    ...
                    this.length > 1 && (jt[t] || yt.uniqueSort(o),
                    It.test(t) && o.reverse()),
                    this.pushStack(o)
                }
            });
            ...
            yt.extend({
                                    ...
                                    var a = this
                                      ...
                                      , u = function() {
                                        ...
                                        if (!(t < s)) {
                                            ...
                                            yt.isFunction(u) ? o ? u.call(n, r(s, e, f, o), r(s, e, p, o)) : (s++,
                                            u.call(n, r(s, e, f, o), r(s, e, p, o), r(s, e, f, e.notifyWith))) : (i !== f && (a = void 0,
                                            l = [n]),
                                            (o || e.resolveWith)(a, l))
                                        }
                                    }
                ...
                when: function(t) {
                    ...
                    if (e <= 1 && (d(t, r.done(s(n)).resolve, r.reject, !e),
            ...
            yt.fn.extend({
                ...
                promise: function(t, e) {
                    ...
                    t = void 0),
                    t = t || "fx"; s--; )
                        (n = Wt.get(r[s], t + "queueHooks")) && n.empty && (i++,
                        n.empty.add(a));
                    return a(),
                    o.promise(e)
                }
                    ...
                    if (m && (l = m.events)) {
                        ...
                        u = e.length; u--; )
                            ...
                            p) {
                                ...
                                s && !f.length && (h.teardown && !1 !== h.teardown.call(t, d, m.handle) || yt.removeEvent(t, p, m.handle),
                                delete l[p])
                            } else
                                for (p in l)
                                    yt.event.remove(t, p + e[u], n, i, !0);
                        yt.isEmptyObject(l) && Wt.remove(t, "handle events")
                    }
                },
                dispatch: function(t) {
                    var e, n, i, o, r, s, a = yt.event.fix(t), l = new Array(arguments.length), u = (Wt.get(this, "events") || {})[a.type] || [], c = yt.event.special[a.type] || {};
                    for (l[0] = a,
            ...
            yt.extend({
                ...
                style: function(t, e, n, i) {
                    if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                        ...
                        r = typeof n,
                        "string" === r && (o = Mt.exec(n)) && o[1] && (n = b(t, e, o),
                        r = "number"),
            ...
            yt.each(["height", "width"], function(t, e) {
                yt.cssHooks[e] = {
                    get: function(t, n, i) {
                        if (n)
                            return !he.test(yt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? B(t, e, i) : Yt(t, pe, function() {
                                return B(t, e, i)
                            })
                    },
                    set: function(t, n, i) {
                        var o, r = i && ce(t), s = i && F(t, e, i, "border-box" === yt.css(t, "boxSizing", !1, r), r);
                        return s && (o = Mt.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n,
                        n = yt.css(t, e)),
                        H(t, n, s)
                    }
                }
            ...
            yt.cssHooks.marginLeft = P(vt.reliableMarginLeft, function(t, e) {
                if (e)
                    return (parseFloat(R(t, "marginLeft")) || t.getBoundingClientRect().left - Yt(t, {
                        marginLeft: 0
                    }, function() {
            ...
            yt.fn.extend({
                ...
                finish: function(t) {
                    return !1 !== t && (t = t || "fx"),
                    this.each(function() {
                        var e, n = Wt.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = yt.timers, s = i ? i.length : 0;
                        for (n.finish = !0,
                        yt.queue(this, t, []),
                ...
                toggleClass: function(t, e) {
                    ...
                    return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : yt.isFunction(t) ? this.each(function(n) {
                        ...
                        if ("string" === n)
                            ...
                            this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Wt.get(this, "__className__") || ""))
                    })
                },
                hasClass: function(t) {
                    var e, n, i = 0;
            ...
            yt.extend(yt.event, {
                trigger: function(t, e, i, o) {
                    var r, s, a, l, u, c, h, f = [i || st], p = dt.call(t, "type") ? t.type : t, d = dt.call(t, "namespace") ? t.namespace.split(".") : [];
                    if (s = a = i = i || st,
                    3 !== i.nodeType && 8 !== i.nodeType && !ke.test(p + yt.event.triggered) && (p.indexOf(".") > -1 && (d = p.split("."),
                    p = d.shift(),
                    d.sort()),
                    u = p.indexOf(":") < 0 && "on" + p,
                    ...
                    o || !h.trigger || !1 !== h.trigger.apply(i, e))) {
                        ...
                        for (r = 0; (s = f[r++]) && !t.isPropagationStopped(); )
                            ...
                            c && c.apply(s, e),
                            (c = u && s[u]) && c.apply && Pt(s) && (t.result = c.apply(s, e),
                            !1 === t.result && t.preventDefault());
                        return t.type = p,
                        o || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(f.pop(), e) || !Pt(i) || u && yt.isFunction(i[p]) && !yt.isWindow(i) && (a = i[u],
                        a && (i[u] = null),
            ...
            vt.focusin || yt.each({
                ...
                yt.event.special[e] = {
                    ...
                    teardown: function() {
                        var i = this.ownerDocument || this
                          , o = Wt.access(i, e) - 1;
                        o ? Wt.access(i, e, o) : (i.removeEventListener(t, n, !0),
                        Wt.remove(i, e))
                    }
                }
            });
            ...
            yt.extend({
                ...
                ajax: function(t, e) {
                    function i(t, e, i, a) {
                        ...
                        i && (x = it(d, C, i)),
                        x = ot(d, x, C, u),
                        u ? (d.ifModified && (w = C.getResponseHeader("Last-Modified"),
                    ...
                    t = void 0),
                    e = e || {};
                    var o, r, s, a, l, u, c, h, f, p, d = yt.ajaxSetup({}, e), g = d.context || d, m = d.context && (g.nodeType || g.jquery) ? yt(g) : yt.event, v = yt.Deferred(), y = yt.Callbacks("once memory"), b = d.statusCode || {}, x = {}, w = {}, T = "canceled", C = {
                        readyState: 0,
                    ...
                    if (d.data && d.processData && "string" != typeof d.data && (d.data = yt.param(d.data, d.traditional)),
                    et(Fe, d, e, C),
                    c)
                        return C;
                    h = yt.event && d.global,
                    ...
                    r = d.url.replace(_e, ""),
                    d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(Le, "+")) : (p = d.url.slice(r.length),
                    d.data && (r += (Ae.test(r) ? "&" : "?") + d.data,
                    delete d.data),
                    !1 === d.cache && (r = r.replace(Re, "$1"),
                    p = (Ae.test(r) ? "&" : "?") + "_=" + $e++ + p),
                    d.url = r + p),
                    d.ifModified && (yt.lastModified[r] && C.setRequestHeader("If-Modified-Since", yt.lastModified[r]),
    ...
    l7pb: function(t, e, n) {
        ...
        !function(s, a) {
            ...
            i._manageStamp = function(t) {
                ...
                for (var u = this._getOption("originTop"), c = (u ? i.top : i.bottom) + n.outerHeight, h = a; h <= l; h++)
...
function myFunction(event) { 
    var x = event.target;
    var picture = x.attributes.src.value;
    avatar.attributes.src.value = picture
    document.getElementById('id01').style.display='block'
}
function shoppingFunction(event) {
    var x = event.target;
    var shoppingImage = x.attributes.src.value;
    document.URL = "file:///home/bami/Documents/Bami/mums_site/project.html"
    var topicPicture = document.getElementById('topic-picture');
    topicPicture.attributes.src.value = shoppingImage;
}
function s() {
  size = document.getElementById("size")
  image = document.getElementById("avatar")
  console.log(size.valueAsNumber)
  image.style.width = size.valueAsNumber + "%"
}